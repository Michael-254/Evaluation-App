                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="invoice p-3 mb-3">
                                                    ...
                                                    <div class="border-double border-4 border-light-blue-500 rounded-md mt-2">
                                                        ...
                                                        <div class="row mt-4 px-2">
                                                            ...
                                                            <div class="form-group col-sm-3">
                                                                ...
                                                                <span>{{$personal_data->review_period}}</span>
                                                            </div>
                                                            <div class="form-group col-sm-3">
                                                                <p class="font-bold text-green-700 mb-2">Last Appraisal Overall Assesment</p>
                                                                <span>{{$personal_data->last_appraisal}}</span>
                                                            </div>
                                                        </div>
                                                        @endforeach
                                                    </div>
                                                    ...
                                                    <div class="border-double border-4 border-light-blue-500 rounded-md mt-2">
                                                        ...
                                                        <form action="{{route('hod.comment',$section_six->id)}}" method="POST">
                                                            @csrf
                                                            @method('patch')
                                                            <div class="row px-4 pt-2">
                                                                <div class="form-group w-full">
                                                                ...
                                                                <div class="form-group w-full">
                                                                    ...
                                                                    <textarea name="hod_comments" class="summernote">{{$section_six->hod_comments ?? ''}}{{ old('hod_comments') }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="row flex justify-end px-4 pt-2 pb-2">
